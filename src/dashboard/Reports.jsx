...
function Reports() {
  ...
  const packageData = getPackageByStudent(
    newReport.studentId
  );

  if (!packageData) {
    alert(
      "Murid ini belum memiliki paket aktif."
    );
    return;
  }
                  ...
                  >
                    ...
                    {!packageStatus.canTeach && (
                      ...
                      <p className="package-block-message">
                        ...
                        🚫 Paket sudah habis.
                        Tutor tidak dapat mengajar
                        murid ini sebelum paket
                        diperbarui.
